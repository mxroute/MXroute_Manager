/*
# mail/spam/views/ROUTES.js                          Copyright 2018 cPanel, Inc.
#                                                           All rights Reserved.
...
/*
# mail/spam/directives/scoreField.js                 Copyright 2018 cPanel, Inc.
#                                                           All rights Reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
...
define(
    ...
    function(angular, LOCALE, CJT) {
        ...
        app.directive("scoreField", ["$timeout", function($timeout) {
            ...
            function _scoreFieldController($scope) {
                ...
                ["scoreType", "scoreValue"].forEach(function(key) {
                    $scope.$watch(key, function(newValue, oldValue) {
                        if ($scope.scoreType && $scope.scoreValue) {
            ...
            var TEMPLATE_PATH = "directives/scoreField.ptt";
            return {
